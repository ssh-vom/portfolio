...
Animation phases: slide along rail → separate sideways → explode internals → reassemble internals → align sideways → slide home. Currently runs as a ten-second timed preview, independent of scrolling, with a Play/Pause control and no pinned section. Reduced motion starts paused; visitors can explicitly play the preview.
