export default [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Centralized traceability for 2K+ engineers by building a full-stack part-tracking platform in React, FastAPI and MongoDB',
      'Improved release reliability by standardizing CI/CD and service deployment with Kubernetes, Docker, and GitHub Actions',
    ],
  },
  {
    company: 'Tesla',
    ...
    bullets: [
      ...
      'Automated 15+ hours of weekly manual work by migrating legacy Excel workflows to a TypeScript/GraphQL API layer',
      'Scaled data-intensive pipeline throughput by 2X through efficient workload batching and Celery worker parallelization',
    ],
  },
  {
    company: 'Tesla',
    ...
    bullets: [
      ...
      'Automated collection of 5K+ images daily for model training through C# integrations with PLC and HMI devices',
      'Improved production cycle times by 12% by optimizing PLC and robot logic in the Tesla Standard Library using TIA Portal',
    ],
  },
];
